...
public class loginController {
    ...
    public void LoginToApplication(ActionEvent e) throws IOException {
        ...
        if(confirmation == 1){
            ...
            User.setName(user);
            User.setPrivilege(DataBase.checkStatus(user));
    ...
    public void Remember(ActionEvent e) throws IOException{
        root = FXMLLoader.load(getClass().getResource("rememberpasswordMenu.fxml"));
        stage = (Stage)((Node)e.getSource()).getScene().getWindow();
        scene = new Scene(root);
